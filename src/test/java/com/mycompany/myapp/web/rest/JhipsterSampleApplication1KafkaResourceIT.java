...
class JhipsterSampleApplication1KafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleApplication1KafkaResource kafkaResource = new JhipsterSampleApplication1KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-application-1-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-application-1-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
