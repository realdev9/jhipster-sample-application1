...
export default class JhiUserManagementComponent extends Vue {
  ...
  public deleteUser(): void {
    this.userManagementService()
      ...
      .then(res => {
        const message = this.$t(res.headers['x-jhipstersampleapplication1app-alert'], {
          param: decodeURIComponent(res.headers['x-jhipstersampleapplication1app-params'].replace(/\+/g, ' ')),
        });
